...
from lepton.app import AppData, LeptonApp, LeptonConfig
...
class SnapCheckAppData(AppData):
    pass
...
app = LeptonApp(config, IOHelper(SnapModel, load_snap, save_snap, new_snap), SnapCheckAppData)
